...
%     grid;
    ...
    x_tf = isoutlier(x2, 'movmedian', 365, 'SamplePoints', t2); % using absolute median deviation on 365-day median 
...
figure('Name', 'Station %s: Positional Time Series', 'NumberTitle', 'off');
subplot(3, 1, 1);
